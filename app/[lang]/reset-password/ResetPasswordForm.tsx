                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-white/[0.03] border border-white/[0.08] focus:border-[#16a085]/50 rounded-xl py-3.5 px-4 text-white text-sm placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-[#16a085]/20 transition-all"
                            placeholder="••••••••"
                        />
