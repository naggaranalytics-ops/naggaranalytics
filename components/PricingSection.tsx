        ...
        <div className="content-layer relative z-10 w-full mb-20">
            <section className="py-24 flex flex-col items-center justify-center relative">
                ...
                <div className="text-center mb-16 px-4 relative z-10">
                    ...
                    <h3 className="text-2xl md:text-3xl text-[#16a085]" dir="rtl">الباقات الإحصائية</h3>
                ...
                <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl relative z-10 items-stretch">
                    ...
                    <div className="h-full">
                        <div className="glass-card rounded-2xl p-6 md:p-8 flex flex-col h-full hover:border-[#16a085]/50 transition-all duration-300">
                            <div className="flex justify-between items-start mb-2">
                                <div className="text-white font-bold text-xl">باقة التأسيس</div>
                            ...
                            <ul className="text-slate-400 space-y-4 mb-8 flex-grow text-sm text-right" dir="rtl">
                            ...
                            <a href="#" className="w-full block text-center py-3 border border-[#16a085] text-[#16a085] hover:bg-[#16a085] hover:text-white rounded-xl transition-all font-semibold mt-auto">اطلب الآن</a>
                        </div>
                    </div>
                    ...
                    <div className="h-full md:-mt-8 md:mb-8 relative z-10 transform md:scale-105">
                        <div className="glass-card bg-[#111821] rounded-2xl p-8 flex flex-col relative h-full border-[#16a085]/50 shadow-2xl shadow-[#16a085]/10">
                            ...
                            <div className="flex justify-between items-start mb-2 mt-2 relative z-10">
                                <div className="text-white font-bold text-2xl">التحليل المتقدم</div>
                            ...
                            <ul className="text-slate-200 space-y-4 mb-8 flex-grow text-sm text-right font-medium relative z-10" dir="rtl">
                            ...
                            <a href="#" className="w-full block text-center py-4 bg-[#16a085] text-white hover:bg-[#149174] rounded-xl transition-all font-bold shadow-lg shadow-black/50 hover:shadow-black/70 mt-auto relative z-10">اطلب الآن</a>
                        </div>
                    </div>
                    ...
                    <div className="h-full">
                        <div className="glass-card rounded-2xl p-6 md:p-8 flex flex-col h-full hover:border-slate-500 transition-all duration-300">
                            <div className="flex justify-between items-start mb-2">
                                <div className="text-white font-bold text-xl">باقة مخصصة</div>
                                <span className="text-slate-400 font-mono text-[10px] border border-slate-600 px-2 py-1 rounded">CUSTOM</span>
                            </div>
                            <div className="text-left text-slate-400 text-sm mb-6 mt-1">الجهات والمراكز</div>
                            <div className="h-px bg-white/10 w-full mb-6"></div>
                            <p className="text-right text-slate-300 leading-relaxed mb-8 flex-grow text-sm" dir="rtl">
                                للمراكز البحثية والجهات التي لديها مجموعة ضخمة من البيانات، يسعدنا التواصل معكم لتحديد باقة تناسب احتياجاتكم بدقة.
                            </p>
                            <a href="#" className="w-full block text-center py-3 border border-slate-600 text-slate-400 hover:border-white hover:text-white rounded-xl transition-all font-semibold mt-auto">تواصل معنا</a>
                        </div>
                    </div>
                </div>
            </section>
