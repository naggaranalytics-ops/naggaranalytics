...
export default function Footer() {
    ...
    return (
        <footer dir={dir} className="border-t py-12 relative z-20 bg-[var(--footer-bg)] border-[var(--border-color)]">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="col-span-1 md:col-span-2">
                    <LocaleLink href="/" className="font-bold text-xl tracking-tighter mb-4 block text-[var(--text-primary)]">
                ...
                <div>
                    <h5 className="font-bold mb-4 text-[var(--text-primary)]">{t("footer.quickLinks")}</h5>
                ...
                <div>
                    <h5 className="font-bold mb-4 text-[var(--text-primary)]">{t("footer.legal")}</h5>
                    <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
            ...
            <div className="max-w-7xl mx-auto px-4 mt-8 pt-8 border-t text-center text-xs font-mono border-[var(--border-color)] text-[var(--text-muted)]">
